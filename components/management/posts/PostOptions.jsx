...
const PostOptions = ({ handleEdit, handleDelete }) => {
        ...
        <div className='relative'>
            ...
            {showOptions &&
                <div className="absolute right-0 mt-2 bg-white shadow-lg rounded-lg">
                    <button onClick={() => { handleEdit(); setShowOptions(false); }} className="block px-4 py-2 text-gray-800 hover:bg-gray-100 w-full text-left">
                        Edytuj
                    </button>
