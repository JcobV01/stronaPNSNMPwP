...
const Kalendarz = () => {
  return (
    <section id="kalendarz" className='my-[140px] flex flex-col gap-[70px] sm:my-[100px] sm:gap-[30px]'>
      <Title title="Kalendarz" title2="Liturgiczny" subtitle="Czytania na każdy dzień"/>

      <article className='flex justify-between w-[1075px] gap-[25px] m-auto mt-[50px] xl:w-[800px] lg:w-[100%] lg:px-[20px] xl:flex-col'>
