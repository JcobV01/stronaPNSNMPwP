...
const Baptism = () => {
  return (
    <article className='w-[1400px]'>
      <h4 className='text-[40px] font-medium tracking-[8px] text-center'>Chrzest</h4>
      <div>
        <h5 className='text-[25px] mt-[15px] tracking-[10px] text-center'>W naszej parafii</h5>
        <ol className='mt-[30px] list-decimal space-y-[30px] tracking-[1.8px] text-[18px]'>
